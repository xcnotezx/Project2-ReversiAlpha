...
//		for(int i = 1; i <= 8; i++){//Check rows
//			for(int j = 1; j <= 8; j++){//Check cols
//				if(r.isLegalMove)
//			}//Check cols
//		}//Check rows
		...
		for(int i = 1; i <= 8; i++){
			for(int j = 1; j <= 8; j++){
				if(r.isLegalMove(i, j, this.getPlayerName())){
					numLegalMoves ++;
					legalMoves = legalMoves.concat(String.valueOf(i));
					legalMoves = legalMoves.concat(String.valueOf(' '));
					legalMoves = legalMoves.concat(String.valueOf(j));
					legalMoves = legalMoves.concat(String.valueOf(','));
				}//if legal
